...
import FbSchedule from './Fb_schedule';
import '../App.css';
...
function GcalDisplay() {
    ...
    return (
        <div>
            <div id='dropdown'><button onClick={() =>getcal()}>Render Calendar</button></div>
            <div><FbSchedule calendar_id = {calendar_id}></FbSchedule></div>
            <div id='G_display'>{calendarDisplay}</div>
        </div>
    );
}
